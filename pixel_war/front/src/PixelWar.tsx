...
const baseAccountSecretKey = 'S1PNNeC922hHaveiosug8GzLidmbfHeu57GnUZsXcbtQm5Gfdfy';
const contractAddress = 'AS12gXZRbxeDA9oU2GGMDNhjhSXH4zftVDb7mjGKkgT4Rt756kvzU';
const gridSize = 300;
...
export const PixelWar: React.FunctionComponent = (): JSX.Element => {
  ...
  useEffect(() => {
    (async () => {
      ...
      const web3Client = await await ClientFactory.createCustomClient(
        providers,
        false,
        baseAccount
      );
