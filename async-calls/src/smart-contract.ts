...
import { send_message, generate_event, get_current_period, Context, Storage, get_balance } from "massa-sc-std"
...
export function receive_and_send(data: string): void {
    ...
    generate_event("GREG REMAINING BALANCE: " + balance.toString());
    ...
    send_message(current_address, "receive_and_send", start_p, 0, end_p, 31, 10_000_000, 0, 0, "You keep getting older...");
}
